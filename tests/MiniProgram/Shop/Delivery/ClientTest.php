...
namespace Surpaimb\WeChat\Tests\MiniProgram\Shop\Delivery;

use Surpaimb\WeChat\Tests\TestCase;
use Surpaimb\WeChat\MiniProgram\Shop\Delivery\Client;

/**
 * 自定义版交易组件开放接口
 *    物流接口
 *
 * @package Surpaimb\WeChat\Tests\MiniProgram\Shop\Delivery
